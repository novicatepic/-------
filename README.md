...
> [!TIP]
> За више информација о *stty* команди може се искористити команда *man stty*.
...
Са слике се може видјети испис времена, географске ширине (*Latitude*), географске дужине (*Longitude*), надморске висине (*Longitude*), брзине у метрима у секунди (*Speed*), параметри *track*, *climb*, кориштени *fix mode* (0 означава да није кориштен, 1 да је кориштен *2D Fix*, а 2 да је кориштен *3D Fix*), *DOP* (Dilution of Precision) који мјери квалитет *GPS* сигнала.
