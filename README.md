...
> [!NOTE]
У оквиру *GPS-Click* остављен је и фајл *gps-manual.c* којим је демонстрирано читање података, без додатног парсирања, директним приступом */dev/ttyS1* гдје се примају *GPS* подаци у одговарајућим форматима. Овакав приступ није препоручљив.
