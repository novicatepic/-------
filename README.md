...
Да би уопште било могуће да се повежемо са развојне платформе, неопходно је на циљној платформи унутар *lib/systemd/system/gpsd.socket* закометарисати (помоћу *#*) линије 
...
Један од примјера је представљен на сљедећој слици (нису детектовани сателити али се у дну јасно могу видјети подаци).
